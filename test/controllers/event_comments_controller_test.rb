...
class EventCommentsControllerTest < ActionController::TestCase
  ...
  test "should create event_comment" do
    assert_difference('EventComment.count') do
      post :create, event_comment: { body: @event_comment.body, event_id: @event_comment.event_id, user_id: @event_comment.user_id }
    end
  ...
  test "should update event_comment" do
    patch :update, id: @event_comment, event_comment: { body: @event_comment.body, event_id: @event_comment.event_id, user_id: @event_comment.user_id }
    assert_redirected_to event_comment_path(assigns(:event_comment))
  end
