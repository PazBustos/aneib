class ContactsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @contact.update(contact_params)
        format.html { redirect_to @contact, notice: 'Su mensaje ha sido editado correctamente.' }
  ...
  def destroy
    @contact.destroy
    respond_to do |format|
      format.html { redirect_to contacts_url, notice: 'Su mensaje ha sido eliminado correctamente.' }
